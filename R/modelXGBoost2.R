...
# setwd(path_models)
# 
# model_XGB_vfn   = readRDS('dataset3_100_weighting_FALSE_removeSparseTerms_0_90_maxdepth_7_nrounds_15000_XGB_model.rds')
# vocab_train_vfn = readRDS('dataset3_100_weighting_FALSE_removeSparseTerms_0_90_maxdepth_7_nrounds_15000_vocab_train.rds')


modelXGBoost2 <- function(fileName){
